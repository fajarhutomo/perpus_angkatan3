...
$ediKategori = mysqli_query($koneksi, "SELECT * FROM kategori WHERE ID = '$id'");
$rowEdit = mysqli_fetch_assoc($ediKategori);
...
<div class="container">
    <div class="row-sm-12">
        <fieldset class="border border-black border-2 p-3">
            <legend class="float-none w-auto px-3"><?php echo isset($_GET['edit']) ? 'Edit' : 'Tambah' ?> Tambah Kategori</legend>
            <div class="box mt-5">
